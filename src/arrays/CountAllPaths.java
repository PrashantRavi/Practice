...
public class CountAllPaths {
	...
	public int countAllResursion(int currentRow, int currentColumn) {
		...
		return countAllResursion(currentRow + 1, currentColumn)
				+ countAllResursion(currentRow, currentColumn + 1)
				+ countAllResursion(currentRow + 1, currentColumn + 1);
	}
